...
var conteo = JSON.parse(localStorage.getItem("contcu"));
	...
	dato=document.getElementById("estaC");

	if (dato=="Ingresos VS Gastos") {

		document.getElementById("vs").insertAdjacentHTML("beforeBegin","<br><br><div id='in'><H2> Ingresos</H2> </div><br><br>");
		document.getElementById("vs").insertAdjacentHTML("beforeBegin","<H1>Gastos</H1>");
		document.getElementById("vs").insertAdjacentHTML("beforeBegin","<br><br><div id='gas'> <H2>Gastos</H2> </div>br><br>");



	}
	else if (dato=="Ingresos") {
